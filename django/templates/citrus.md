...
* Tech: Vue.js, Django, K8S, Wetty, Jenkins, Sonarqube
...
I designed the platform that needs essential information like oss path, branch name, package name, ETC.
And using that information it turns into Jenkins pipeline job. 
Each developer need their own environment to build and test so I also put image modification feature.

## Result
Currently more than a 60 services use our platform.
I uploaded with core screenshots of our product.
